<template>
    <div>
        <b-row class="text-center">
            ...
            <div class="w-100"></div>
            <b-col class="link" @click="profile"><p>{{ currentUser.name + " " + currentUser.lastname }}</p></b-col>
        </b-row>
        ...
        <b-row class="row-link">
            <b-col class="nav-menu" v-b-toggle:Tags>
                <div class="d-flex justify-content-between align-items-center nav-menu-inside">
                    <a href="#">Tags</a>
