<template>
        <div class="mt-4 form">
            <div class="mb-3 d-flex justify-content-between">
                <h3>Submissions:</h3>
                <b-button variant="outline-primary" @click="$router.push('/tracking')">Submissions</b-button>
            </div>
            <vue-good-table
                    class="mb-4"
            ...
            >
                <template slot="table-row" slot-scope="props">
                    ...
                    <div v-if="props.column.field === 'accept'"
                         class="table-row d-flex justify-content-center">
                        <b-button @click="closeSubmission(props.row.id)" variant="outline-info" v-if="!props.formattedRow.accepted">Close</b-button>
                        <b-button @click="openSubmission(props.row.id)" variant="outline-warning" v-if="props.formattedRow.accepted">Open</b-button>
                    </div>
